...
-- Escrita do backend (proxy RCO sincroniza os dados)
CREATE POLICY "escrita_backend" ON rco_estabelecimentos FOR INSERT WITH CHECK (true);
CREATE POLICY "escrita_backend" ON rco_turmas           FOR INSERT WITH CHECK (true);
CREATE POLICY "escrita_backend" ON rco_disciplinas      FOR INSERT WITH CHECK (true);
CREATE POLICY "escrita_backend" ON rco_classes          FOR INSERT WITH CHECK (true);
CREATE POLICY "escrita_backend" ON rco_sync_log         FOR INSERT WITH CHECK (true);
CREATE POLICY "update_backend"  ON rco_estabelecimentos FOR UPDATE USING (true);
CREATE POLICY "update_backend"  ON rco_turmas           FOR UPDATE USING (true);
CREATE POLICY "update_backend"  ON rco_disciplinas      FOR UPDATE USING (true);
CREATE POLICY "update_backend"  ON rco_classes          FOR UPDATE USING (true);
